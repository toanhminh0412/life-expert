...
function Signup() {
  ...
  return (
      <div className='pt-2 md:pt-16 lg:pl-40 lg:pt-4 bg-indigo-100 h-full pb-auto min-h-screen pb-8'>
        <h1 className='text-6xl font-bold pt-32 ml-8 md:ml-20 lg:ml-40 xl:ml-60'>Sign Up</h1>
        ...
        <form className="flex flex-col w-fit ml-10 mt-10 md:ml-32 lg:ml-56 xl:ml-72" onSubmit={createAccount}>
            ...
            <input type='password' name='re-password' placeholder='Retype password' className='h-12 w-72 xl:w-80 rounded-sm mt-8 text-xl p-2 border shadow-md' onChange={typePassword2}/>
            <p className='text-lg mt-4'>Already have an account? Click <a href='/login' className='font-bold underline text-lg'>here</a> to log in</p>
            <input type='submit' value='Register' className='w-28 h-10 text-white bg-indigo-500 rounded-sm mt-8 ml-auto text-lg hover:bg-indigo-700 duration-200 mr-4'/>
        </form>
    </div>
  );
}
